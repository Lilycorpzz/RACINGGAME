...
#include "RACINGGAMEOffroadCar.h"
#include "RACINGGAMEOffroadWheelFront.h"
#include "RACINGGAMEOffroadWheelRear.h"
#include "ChaosWheeledVehicleMovementComponent.h"
#include "GameFramework/SpringArmComponent.h"

ARACINGGAMEOffroadCar::ARACINGGAMEOffroadCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = URACINGGAMEOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = URACINGGAMEOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = URACINGGAMEOffroadWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = URACINGGAMEOffroadWheelRear::StaticClass();
